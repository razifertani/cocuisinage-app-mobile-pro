...
Future<Either<Exception, String>> sendInvitationLinkWS(
...
Future<Either<Exception, String>> acceptInvitationLinkWS(
    {required String invitationLink, required String password}) async {
  try {
    final response = await http.post(
      Uri.parse(
