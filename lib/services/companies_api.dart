...
Future<Either<Exception, String>> updateCompanyWS({required int companyID, required String name, required String email, required String phoneNumber, required String rib, required String siret}) async {
  try {
