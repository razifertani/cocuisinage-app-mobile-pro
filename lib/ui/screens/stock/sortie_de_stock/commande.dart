...
import '../../../shared/widgets/common_product_card.dart';
...
class CommandeSortieDeStock extends StatefulWidget {
  const CommandeSortieDeStock({Key? key}) : super(key: key);

  @override
  State<CommandeSortieDeStock> createState() => _CommandeSortieDeStockState();
}

class _CommandeSortieDeStockState extends State<CommandeSortieDeStock> {
  int currentIndex = 0;
            ...
            GridView.builder(
                ...
                itemBuilder: (BuildContext ctx, index) {
                  return GestureDetector(
                      onTap: () {
                        Utils.pushScreen(
                            context, PopUpScreenSortieDeStock(), 0.5);
                      },
