...
class MenuSortieDeStock extends StatefulWidget {
  const MenuSortieDeStock({Key? key}) : super(key: key);

  @override
  State<MenuSortieDeStock> createState() => _MenuSortieDeStockState();
}

class _MenuSortieDeStockState extends State<MenuSortieDeStock> {
  int currentIndex = 0;
