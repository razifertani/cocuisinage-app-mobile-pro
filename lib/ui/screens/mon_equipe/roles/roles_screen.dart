...
import 'package:cocuisinage_app_mobile_pro_mobile_pro/ui/shared/widgets/roles/ajouter_role_popup.dart';
import 'package:cocuisinage_app_mobile_pro_mobile_pro/ui/shared/widgets/roles/role_card.dart';
          ...
          child: Column(
            ...
            children: [
              ...
              ListView.builder(
                shrinkWrap: true,
                physics: BouncingScrollPhysics(),
                itemCount: Globals.config.roles
                    .where((element) =>
