...
import 'package:cocuisinage_app_mobile_pro/services/collegue_api.dart';
...
class _AjouterEquipierState extends State<AjouterEquipier> {
  ...
  void initState() {
    ...
    Globals.config.roles.forEach((element) {
      if (element.establishmentId == Globals.params.currentEstablishmentID && element.id != Role.PATRON) {
