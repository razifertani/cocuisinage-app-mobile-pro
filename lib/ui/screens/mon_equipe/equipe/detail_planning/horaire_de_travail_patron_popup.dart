...
class HoraireDeTravailPatronPopUp extends StatefulWidget {
  ...
  const HoraireDeTravailPatronPopUp({Key? key, required this.planning})
      : super(key: key);

  @override
  State<HoraireDeTravailPatronPopUp> createState() =>
      _HoraireDeTravailPatronPopUpState();
}

class _HoraireDeTravailPatronPopUpState
    extends State<HoraireDeTravailPatronPopUp> {
                                ...
                                onTap: () async {
                                  final TimeOfDay? newTime =
                                    ...
                                    initialTime: TimeOfDay(
                                        hour: planning.shouldStartAt.hour,
                                        minute: planning.shouldStartAt.minute),
                                    builder:
                              ...
                              child: GestureDetector(
                                onTap: () async {
                                  final TimeOfDay? newTime =
                                    ...
                                    context: context,
                                    initialTime: TimeOfDay(
                                        hour: planning.shouldFinishAt!.hour,
                                        minute:
                                            planning.shouldFinishAt!.minute),
                                    builder:
                                        (BuildContext context, Widget? child) {
                                      return MediaQuery(
                                          data: MediaQuery.of(context).copyWith(
                                ...
                                child: Padding(
                                  ...
                                  child: Text(
                                    DateFormat.Hm()
                                        .format(planning.shouldFinishAt!),
                                    style: MyTextStyles.headline
                                        .copyWith(fontWeight: FontWeight.w600),
                                  ),
                                ),
