...
class HoraireDeTravailAutreEmployePopUp extends StatefulWidget {
  ...
  final DateTime day;
  HoraireDeTravailAutreEmployePopUp(
      {Key? key,
  ...
  @override
  State<HoraireDeTravailAutreEmployePopUp> createState() =>
      _HoraireDeTravailAutreEmployePopUpState();
}

class _HoraireDeTravailAutreEmployePopUpState
    extends State<HoraireDeTravailAutreEmployePopUp> {
  @override
          ...
          return SizedBox(
            ...
            child: Padding(
              ...
              child: Column(children: [
                ...
                Text(
                  widget.planning.startedAt == null
                      ? "Vous commencez votre jounrnée de travail à "
                      : "Vous allez terminer à ",
                ...
                CustomButton(
                  txt: widget.planning.startedAt == null
                      ? "Commencer"
                      : "Terminer",
