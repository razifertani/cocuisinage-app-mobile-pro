...
class RecetteFavorites extends StatefulWidget {
  RecetteFavorites({Key? key}) : super(key: key);

  @override
  State<RecetteFavorites> createState() => _RecetteFavoritesState();
}

class _RecetteFavoritesState extends State<RecetteFavorites> {
