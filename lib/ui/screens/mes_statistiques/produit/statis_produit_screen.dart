...
class StatisProduitScreen extends StatefulWidget {
  const StatisProduitScreen({Key? key}) : super(key: key);

  @override
  State<StatisProduitScreen> createState() => _StatisProduitScreenState();
}

class _StatisProduitScreenState extends State<StatisProduitScreen> {
      ...
      child: SingleChildScrollView(
        child: Column(
          children: [
            ...
            RecStatCard(
                nomDeRec: "Salade de légumes",
                prix: "Prix de vente/personne :  12"),
            const SizedBox(
              height: 20,
            ),
          ],
