...
class _ModifierBoutiqueScreenState extends State<ModifierBoutiqueScreen> {
  ...
  EstablishmentsRoles establishmentsRoles = Globals.profile.establishmentsRoles
      .firstWhere(
          (element) => element.id == Globals.params.currentEstablishmentID);
                ...
                children: [
                  ...
                  Padding(
                    ...
                    child: GestureDetector(
                      ...
                      child: image == null
                          ? Image.network(establishmentsRoles.imageUrl)
                          : Image.file(image!),
                    ),
                  ),
                  const SizedBox(
