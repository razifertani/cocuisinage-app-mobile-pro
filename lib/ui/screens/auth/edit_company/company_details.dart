...
import 'package:cocuisinage_app_mobile_pro_mobile_pro/services/companies_api.dart';
...
class _CompanyDetailsState extends State<CompanyDetails> {
  ...
  TextEditingController companyName =
      TextEditingController(text: Globals.profile.company.name);
  TextEditingController companyEmail =
      TextEditingController(text: Globals.profile.company.email);
  TextEditingController companyPhoneNumber =
      TextEditingController(text: Globals.profile.company.phoneNumber);
  TextEditingController companyRib =
      TextEditingController(text: Globals.profile.company.rib);
  TextEditingController companySiret =
      TextEditingController(text: Globals.profile.company.siret);
