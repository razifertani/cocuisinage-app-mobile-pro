import 'package:cocuisinage_app_mobile_pro_mobile_pro/layout/layout_screen.dart';
...
import 'package:cocuisinage_app_mobile_pro_mobile_pro/services/fcm_service.dart';
import 'package:cocuisinage_app_mobile_pro_mobile_pro/services/permissions_service.dart';
import 'package:cocuisinage_app_mobile_pro_mobile_pro/ui/screens/auth/edit_company/company_details.dart';
import 'package:cocuisinage_app_mobile_pro_mobile_pro/ui/screens/auth/mes_boutiques/modif_popup.dart';
import 'package:cocuisinage_app_mobile_pro_mobile_pro/ui/screens/boutique/creer_boutique/creer_boutique_details.dart';
import 'package:cocuisinage_app_mobile_pro_mobile_pro/ui/screens/home/employe_home_screen.dart';
                      ...
                      itemBuilder: (context, index) {
                        return GestureDetector(
                          onLongPress: () {
                            if (Globals.profile.isOwner) {
                              Globals.params.currentEstablishmentID =
                                  Globals.profile.establishmentsRoles[index].id;
                          ...
                          child: BoutiqueCardAuth(
                            name:
                                '${Globals.profile.establishmentsRoles[index].name}\n${Globals.config.roles.firstWhere((element) => element.id == Globals.profile.establishmentsRoles[index].pivotEstablishmentsRoles.roleId).name}',
                            address:
                                '${Globals.profile.establishmentsRoles[index].city}',
                            imgPath:
                                '${Globals.profile.establishmentsRoles[index].imageUrl}',
                            rate: 5,
                          ),
                        );
                      },
