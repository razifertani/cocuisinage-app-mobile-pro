...
import 'package:cocuisinage_app_mobile_pro/ui/screens/auth/modifier_boutique/modifier_boutique.dart';
    ...
    return Scaffold(
      ...
      child: Column(
        children: [
          ...
          GestureDetector(
            onTap: () {
              Navigator.push(context, MaterialPageRoute(builder: ((context) => ModifierBoutiqueScreen())));
            },
            child: SizedBox(
